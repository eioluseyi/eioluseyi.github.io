...
watchEffect(() => {
    ...
    const showClass = 'opacity-100 p-6 pb-0 min-w-full max-w-full';
...
<template>
    <div ref="componentRef"
        class="min-w-full sticky p-6 pb-0 rounded-3xl custom-transition-properties [&>div]:pointer-events-none duration-300 ease-[cubic-bezier(0,1,0.7,1.02)] overflow-hidden border-[#ffffff07] flex-1 [&>div]:h-full [&>div]:overflow-hidden"
